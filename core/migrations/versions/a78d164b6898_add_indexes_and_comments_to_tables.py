...
def upgrade() -> None:
    ...
    op.alter_column('profile', 'user_id',
               ...
               existing_nullable=False)
    op.alter_column('profile', 'display_name',
               existing_type=sa.TEXT(),
    ...
    op.alter_column('uploadedimage', 'image',
               existing_type=sa.VARCHAR(length=255),
               comment='Name or identifier of the uploaded image',
               existing_nullable=False)
    op.alter_column('uploadedimage', 'uploaded_at',
               existing_type=postgresql.TIMESTAMP(),
               comment='Timestamp when the image was uploaded',
               existing_nullable=True)
    op.alter_column('uploadedimage', 'file_path',
               existing_type=sa.TEXT(),
