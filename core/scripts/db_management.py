...
def main():
    ...
    gen_parser = subparsers.add_parser("generate_migration", help="Generate a new database migration")
    gen_parser.add_argument("message", nargs="?", help="Migration message/description")
    
    # apply_migrations command
    apply_parser = subparsers.add_parser("apply_migrations", help="Apply pending migrations to the database")
    ...
    reset_parser = subparsers.add_parser("reset_database", help="Reset the development database")
    
    # export_schema command
    export_parser = subparsers.add_parser("export_schema", help="Export the current database schema to SQL")
    
    # compare_schemas command
    compare_parser = subparsers.add_parser("compare_schemas", help="Compare schemas between environments")
    compare_parser.add_argument("source_env", choices=["development", "staging", "production"], 
                               help="Source environment")
    compare_parser.add_argument("target_env", choices=["development", "staging", "production"], 
