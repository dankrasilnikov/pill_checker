...
class TestProfileModel:
    ...
    def test_profile_schema_validation(self, sample_profile_data):
        ...
        with pytest.raises(ValidationError):
            ProfileCreate(user_id="invalid-uuid", **{k: v for k, v in sample_profile_data.items() if k != "user_id"})
...
class TestMedicationModel:
    ...
    def test_medication_model_create(self, test_db_session, sample_profile_data, sample_medication_data):
    ...
    def test_medication_schema_validation(self, test_db_session, sample_profile_data, sample_medication_data):
    ...
    def test_medication_schema_from_model(self, test_db_session, sample_profile_data, sample_medication_data):
