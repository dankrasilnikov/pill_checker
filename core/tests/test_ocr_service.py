...
def setup_module(module):
    ...
    if not image_files:
        try:
            ...
            from create_test_image import create_multiple_test_images
    ...
    def test_ocr_with_test_images(self, ocr_client, test_images_dir):
        ...
        for image_file in image_files:
            ...
            if "prescription" in image_file.name.lower():
                ...
                expected_keywords = ["TABLET", "DAILY", "Ibuprofen", "MEDICATION", "CHILDREN", "Store"]
            else:
            ...
            found_keywords = [keyword for keyword in expected_keywords 
            ...
            assert sum(extracted_info.values()) > 0, \
